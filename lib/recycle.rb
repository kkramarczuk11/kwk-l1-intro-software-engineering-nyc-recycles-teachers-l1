...
def borough(second_recycling_bin)
  second_recycling_bin["borough"]
end
...
def all_keys(third_recycling_bin)
  third_recycling_bin.each_key {|key|
    puts key}
end
...
def all_data(fourth_recycling_bin)
  fourth_recycling_bin.each_value {|value|
    puts value}
end
